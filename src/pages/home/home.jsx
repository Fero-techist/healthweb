...
const Home = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* hero-section */}
      <section className="lg:px-24 px-4 py-9 flex md:flex-row flex-col gap-12 md:gap-0 items-center justify-between">
        ...
        <img src="assets/hero-image.png" className="w-[35rem]" alt="" />
      </section>
      ...
      {/* Doctors */}
      <section>
        <h1 className="text-3xl font-medium text-center">Meet our Doctors</h1>
        <p className="text-lightGrey text-sm text-center mb-5">
          Well qualified Doctors are ready to serve you
        </p>
        <Doctors doctor={doctor} doctorRef={doctorRef} />
