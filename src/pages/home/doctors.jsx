...
const Doctors = ({ doctor, docRef }) => {
  return (
    <div className="flex items-center justify-center" ref={docRef}>
      <div className="grid items-center gap-10 justify-center md:grid-cols-2 grid-cols-1">
        {doctor.map((item) => (
          ...
          >
            ...
            <p>{item.category}</p>
            <img src="assets/Raiting.png" alt="" />
            <Button
              css={
                "bg-white rounded-2xl text-deepBlue border-[1px] border-deepBlue py-2 px-6"
              }
